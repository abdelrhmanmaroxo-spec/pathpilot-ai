...
import {
  Activity, AlertTriangle, Ban, Bot, BriefcaseBusiness, CheckCircle2, Crown, Download,
  GraduationCap, KeyRound, LogIn, MailPlus, MessageSquareText, RefreshCw, ShieldCheck,
  Sparkles, Trash2, Users, XCircle,
} from 'lucide-react';
import {
...
function EmptyAdmin({ children }) { return <div className="admin-empty">{children}</div>; }
...
export default function AdminDashboard({ user, onBack }) {
  ...
  return (
    <main className="admin-page page-shell">
      ...
      {tab === 'analytics' && <section className="admin-grid">
