...
const EXPLICIT_FEMALE = /(?:\b(?:i am|i'm)\s+(?:a\s+)?(?:woman|girl|female)\b|(?:^|\s)(?:انا|اني)\s+(?:بنت|ست|سيده|سيدة|امراه|امرأة|فتاه|فتاة|شابه|شابة|انثي|انثى|أنثى)(?:\s|$))/i;

const MALE_SELF_FORMS = [
  'محتاج', 'جاهز', 'تعبان', 'مبسوط', 'زعلان', 'متوتر', 'محتار', 'زهقان', 'فرحان', 'مشغول', 'متاكد', 'متأكد',
  'عايز', 'كويس', 'قلقان', 'مضغوط', 'متضايق', 'مرهق', 'مستعد',
];
const FEMALE_SELF_FORMS = [
  ...
  'متاكده', 'متاكدة', 'متأكده', 'متأكدة', 'عايزه', 'عايزة', 'كويسه', 'كويسة', 'قلقانه', 'قلقانة',
  'مضغوطه', 'مضغوطة', 'متضايقه', 'متضايقة', 'مرهقه', 'مرهقة', 'مستعده', 'مستعدة',
];
...
const FEMALE_REPLACEMENTS = [
  ...
  ['تحب نشتغل', 'تحبي نشتغل'],
  ['إنت محتاج', 'إنتِ محتاجة'],
  ['إنت مش محتاج', 'إنتِ مش محتاجة'],
  ['محتاج نعمل إيه؟', 'محتاجة نعمل إيه؟'],
  ['متستناش', 'متستنيش'],
  ['اعمل أول', 'اعملي أول'],
  ['شد حيلك', 'شدي حيلك'],
  ['ركّز', 'ركّزي'],
...
const NEUTRAL_REPLACEMENTS = [
  ...
  ['أهلًا بيك.', 'أهلًا.'],
  ['أهلًا بيك', 'أهلًا'],
  ['تحب نشتغل على إيه؟', 'نشتغل على إيه؟'],
  ...
  ['وقت ما تحب', 'في أي وقت'],
  ['لما ترجع', 'لما تكون هنا تاني'],
  ['ماشية معاك', 'ماشية كويس'],
  ['ظبط معاك', 'ظبط'],
  ...
  ['اعمل أول', 'نبدأ بأول'],
  ['ركّز على', 'خلينا نركز على'],
  ['تقدر تعمله', 'ممكن يتعمل'],
  ['خلّص الخطوة', 'نخلّص الخطوة'],
  ['محتاج توصل لإيه', 'إيه الهدف المطلوب'],
  ['اللي عايز توصله', 'الهدف المطلوب'],
