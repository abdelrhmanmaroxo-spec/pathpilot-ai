...
const TOKEN_ARCHETYPES = [
  ...
  { intent: 'acknowledgement', any: ['ok', 'okay', 'okey', 'cool', 'perfect', 'yeah', 'yep', 'alright', 'tmam', 'tamam', 'mashy', 'mashi', 'eshta', 'تمام', 'ماشي', 'اشطا', 'وصلت', 'فهمت', 'فاهم', 'ايوه', 'اها'], maxMeaningfulFillers: 2 },
