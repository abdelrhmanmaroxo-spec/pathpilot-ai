...
| A22 | DONE | Relevance-aware conversation context, follow-up resolution, new-topic isolation, long-chat relevant-turn retrieval, and safe in-chat Arabic grammatical-form carryover without storing a demographic profile |
...
| A33 | DONE | Natural local final answers with semantic short-message archetypes, Egyptian Arabizi/Romanized-Arabic recognition, reciprocal/presence turns, filler-aware mixed-language matching, safe masculine/feminine/neutral Arabic address from strong in-chat self-reference, action-bearing fallthrough, and language-scoped near-duplicate avoidance without forcing research/RAG templates |
