...
| A33 | DONE | Natural local final answers with lightweight casual-conversation intent routing, semantic short-message archetypes, action-bearing fallthrough, and on-device non-repeating response variation without forcing research/RAG templates |
